	...
	renderExpense(expense) {
		return (
			<tr key={expense.id}>
					...
					<input
						...
						onBlur={e => {
							if (e.target.value.trim() !== expense.description)
								this.updateExpense(expense.id, { description: e.target.value.trim() })
						}}
						className="bg-gray"
					/>
				</td>
				...
				<td>
					<a onClick={() => this.handleExpenseDelete(expense.id)} className="dim-til-hover">
